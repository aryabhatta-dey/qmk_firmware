...
#define SYM_R2                     
#define SYM_R3                     
#define SYM_THUMB_CLUSTER

#define NAV_R1                     
#define NAV_R2                     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  KC_NO
#define NAV_R3                     KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R,  KC_NO

#define LAYOUT_wrapper(...) LAYOUT_split_3x5_3(__VA_ARGS__)

enum layer_names { COLEMAKDHM, NUM, SYM, FUN, MEDIA, NAV };
